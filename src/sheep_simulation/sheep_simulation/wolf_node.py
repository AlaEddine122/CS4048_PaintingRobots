...
class WolfSimulationNode(Node):
    def __init__(self):
        ...
        self.wolf_pen_locations = {
            "wolf1": (-25.0 + 5.0, 25.0 - 5.0),
            "wolf2": (-25.0 + 5.0, -25.0 + 5.0),
        }
    ...
    def update_wolf_position(self, wolf_pose, wolf_index):
        def is_in_pen(x, y, pen_x_min, pen_y_min, pen_size=10.0):
            return pen_x_min <= x <= pen_x_min + pen_size and pen_y_min <= y <= pen_y_min + pen_size
